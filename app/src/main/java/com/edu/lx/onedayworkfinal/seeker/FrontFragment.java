...
import static com.edu.lx.onedayworkfinal.seeker.SeekerMainActivity.MY_WORK_FRAGMENT;
...
public class FrontFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //일감 관리
        my_work.setOnClickListener(v -> activity.changeFragment(MY_WORK_FRAGMENT));
        //이력정보 메뉴
