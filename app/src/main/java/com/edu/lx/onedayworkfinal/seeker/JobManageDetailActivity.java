...
public class JobManageDetailActivity extends AppCompatActivity {
...
//    TextView requirement;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seeker_accept_job_manage_detail);
...
//        cancelButton.setOnClickListener(v -> show());
    ...
    private void requestManageProjectDetail () {
        ...
        String url = getResources().getString(R.string.url) + "requestjobManageDetail.do";
        Log.d("this", String.valueOf(candidateNumber));
        StringRequest request = new StringRequest(
                Request.Method.POST,
                url,
                this::processJobManageDetail,
                error -> {
    ...
    //프로젝트 상세정보 처리
    private void processJobManageDetail (String response) {
