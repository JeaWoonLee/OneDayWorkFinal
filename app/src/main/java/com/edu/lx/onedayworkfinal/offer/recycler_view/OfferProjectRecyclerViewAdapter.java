...
public class OfferProjectRecyclerViewAdapter extends BaseRecyclerViewAdapter<OfferWorkVO> {


    public OfferProjectRecyclerViewAdapter(Context context) {
        super(context);
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(inflateView(context, R.layout.offer_project_today_item,viewGroup));
    }
